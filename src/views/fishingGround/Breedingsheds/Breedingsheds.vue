        ...
        <div class="plant-table">
            <el-card class="card-padding-bottom">
                <el-table :data="houseData">
                    ...
                    <el-table-column prop="OxygenContent" label="含氧量"> </el-table-column>
                    <el-table-column prop="NitrogenAmmoniaContent" label="氮氨含量"> </el-table-column>
                    ...
                    <el-table-column prop="address" label="鱼池位置"> </el-table-column>
