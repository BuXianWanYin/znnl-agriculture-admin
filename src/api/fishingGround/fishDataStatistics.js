...
export function selectFishBaseInfo() {
    return request({
      url: '/fishPasture/statistics/selectFishBaseInfo',
      method: 'get'
    })
}
...
//     })
// }
export function selectFishTaskInfo() {
    return request({
      url: '/fishPasture/statistics/selectFishTaskInfo',
      method: 'get'
    })
}
